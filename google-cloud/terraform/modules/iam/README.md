...
| env  | Roles created |
|------|----------------|
| dev  | `safarDevDeployer`, `safarDevDeployerGlobal`, `safarDevReadonly`, `safarDevReadonlyGlobal` |
| stg  | `safarStgDeployer`, `safarStgDeployerGlobal`, `safarStgReadonly`, `safarStgReadonlyGlobal` |
| prod | `safarProdDeployer`, `safarProdDeployerGlobal`, `safarProdReadonly`, `safarProdReadonlyGlobal` |
