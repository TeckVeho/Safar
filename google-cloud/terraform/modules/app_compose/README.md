...
Composition module for the Safar **app** stack: wires `iam`, `gcs`, `cloud_sql`, `secrets`, `cloud_run`, `app_cron`, `sql_schedule`, tier specs, network remote state, and disabled scaffold modules (`armor`, `dns`, `lb`, `monitoring`).
